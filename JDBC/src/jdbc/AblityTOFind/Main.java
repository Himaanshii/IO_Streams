...
public class Main {
    public static void main(String[] args) throws Exception {
       ...
       String Quary1 = "SELECT COUNT(gender) AS male_count FROM Employee_payroll WHERE gender = 'M'";
       String Quary2 = "SELECT COUNT(gender) AS female_count FROM Employee_payroll WHERE gender = 'f'";
